package com.example.seamy.masterflow;
...
import com.example.seamy.masterflow.dummy.DummyContent;
...
public class WebpageDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ...
            ((WebView) rootView.findViewById(R.id.detail_area)).loadUrl(mItem);
